...
export default function AdminLoginPage() {
  ...
  const handleSocialLogin = async (loginFn: () => Promise<void>, provider: string) => {
    setError('');
    setLoading(true);
    ...
    <div className="min-h-screen bg-warm flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-medium p-8">
        ...
        <div className="space-y-3">
          ...
          {/* 카카오 로그인 */}
          <button
            onClick={() => handleSocialLogin(signInWithKakao, 'Kakao')}
            disabled={loading}
          ...
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 3C6.477 3 2 6.477 2 10.8c0 2.8 1.8 5.2 4.5 6.6-.2.8-.6 2.3-.7 2.6-.1.4.1.4.3.3.2 0 2.8-1.9 3.2-2.2.6.1 1.1.1 1.7.1 5.5 0 10-3.5 10-7.8S17.5 3 12 3z"/>
            </svg>
